...
public class CommunicationHandlerApp extends Application {
    //Declare a private RequestQueue variable
    private RequestQueue requestQueue;
    private static CommunicationHandlerApp mInstance;
    public void onCreate() {
        super.onCreate();
        mInstance = this;
    }
    public static synchronized CommunicationHandlerApp getInstance() {
        return mInstance;
    }
    /*
